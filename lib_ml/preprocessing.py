...
def tokenize_input(raw_x):
    ...
    return char_index, x_tokenized[0]

# preprocess entire dataset
def preprocess_dataset(dataset_folder = "data/raw/DL Dataset/", train_file="train.txt",
                  test_file="test.txt", val_file="val.txt", output_folder = "data/interim"):
    ...
    raw_x, raw_y = split_dataset(dataset_folder, train_file, test_file, val_file)
...
def preprocess_input(input):
    """Preprocesses the input data and returns char_index, tokenized_x."""
    char_index, tokenized_x = tokenize_input(input)
    return char_index, tokenized_x

# print(preprocess_input("test haha"))